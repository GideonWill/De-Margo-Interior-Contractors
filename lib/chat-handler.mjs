...
function friendlyClaudeFailure(status, message) {
  ...
  if (status === 429 || /rate limit|quota|billing|credit/i.test(text)) {
    return 'Our AI assistant is temporarily unavailable due to a service limit. Please call 0546478040, email demargo1987@gmail.com, or WhatsApp wa.me/233546478040 — our team can help you right away.'
  }
