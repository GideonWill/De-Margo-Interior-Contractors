        ...
        {lightbox.open && lightbox.fabric && (
          ...
          >
            <motion.div 
              ...
              className="bg-white border border-slate-800 max-w-xl w-full flex flex-col overflow-hidden shadow-2xl relative"
            >
              {/* Close Button */}
              <button 
                onClick={closeLightbox}
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="border-t border-slate-100 pt-3 flex flex-col gap-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button 
                      onClick={closeLightbox}
                      className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-755 font-bold text-xs transition uppercase tracking-wider"
                    >
                      Cancel
                    </button>
                  </div>
